...
@Component({
    ...
    template:`
            ...
            `,
    styles:[
        '.landing {background: linear-gradient(rgba(255,255,255,.5), rgba(255,255,255,.5)), url("src/assets/images/landing_bg.jpeg")  no-repeat center center fixed; background-size: cover;}',
